...
class DataWriterTest {
    ...
    void testWritingFiveSuspects() {
        suspectList.add(new Suspect("Joey", "Pearson", "555-555-3983", "4016 Pooh Bear Lane", "Smokey", 25, 200,
                "6'1\"", "White", "Male", "Blue", 11.0, "Blonde", "Short", "Clean", "Baggy", true, true,
                "2004 Honda Civic", "LV9-Z4D"));
        suspectList.add(new Suspect("Joey", "Pearson1", "555-555-3983", "4016 Pooh Bear Lane", "Smokey", 25, 200,
                "6'1\"", "White", "Male", "Blue", 11.0, "Blonde", "Short", "Clean", "Baggy", true, true,
                "2004 Honda Civic", "LV9-Z4D"));
        suspectList.add(new Suspect("Joey", "Pearson2", "555-555-3983", "4016 Pooh Bear Lane", "Smokey", 25, 200,
                "6'1\"", "White", "Male", "Blue", 11.0, "Blonde", "Short", "Clean", "Baggy", true, true,
                "2004 Honda Civic", "LV9-Z4D"));
        suspectList.add(new Suspect("Joey", "Pearson3", "555-555-3983", "4016 Pooh Bear Lane", "Smokey", 25, 200,
                "6'1\"", "White", "Male", "Blue", 11.0, "Blonde", "Short", "Clean", "Baggy", true, true,
                "2004 Honda Civic", "LV9-Z4D"));
        suspectList.add(new Suspect("Joey", "Pearson4", "555-555-3983", "4016 Pooh Bear Lane", "Smokey", 25, 200,
                "6'1\"", "White", "Male", "Blue", 11.0, "Blonde", "Short", "Clean", "Baggy", true, true,
                "2004 Honda Civic", "LV9-Z4D"));
        DataWriter.saveSuspects();
    ...
    void testWritingEmptySuspect() {
        suspectList
                .add(new Suspect("", "", "", "", "", 0, 0, "", "", "", "", 0.0, "", "", "", "", false, false, "", ""));
        DataWriter.saveSuspects();
    ...
    void testWritingNullSuspect() {
        suspectList.add(
                new Suspect(null, null, "", "", "", 0, 0, "", "", "", "", 0.0, "", "", "", "", false, false, "", ""));
        DataWriter.saveSuspects();
    ...
    void testWritingFiveCriminals() {
        criminalList.add(new Criminal("Benjamin", "Lariviere", "555-746-8803", "419 Broadway Street", "Benchode", 23,
                155, "5'5\"", "White", "Male", "Blue", 8.0, "Black", "Short", "Clean", "Varies", true, false, "No car",
                "AKR-583", true));
        criminalList.add(new Criminal("Benjamin", "Lariviere1", "555-746-8803", "419 Broadway Street", "Benchode", 23,
                155, "5'5\"", "White", "Male", "Blue", 8.0, "Black", "Short", "Clean", "Varies", true, false, "No car",
                "AKR-583", true));
        criminalList.add(new Criminal("Benjamin", "Lariviere2", "555-746-8803", "419 Broadway Street", "Benchode", 23,
                155, "5'5\"", "White", "Male", "Blue", 8.0, "Black", "Short", "Clean", "Varies", true, false, "No car",
                "AKR-583", true));
        criminalList.add(new Criminal("Benjamin", "Lariviere3", "555-746-8803", "419 Broadway Street", "Benchode", 23,
                155, "5'5\"", "White", "Male", "Blue", 8.0, "Black", "Short", "Clean", "Varies", true, false, "No car",
                "AKR-583", true));
        criminalList.add(new Criminal("Benjamin", "Lariviere4", "555-746-8803", "419 Broadway Street", "Benchode", 23,
                155, "5'5\"", "White", "Male", "Blue", 8.0, "Black", "Short", "Clean", "Varies", true, false, "No car",
                "AKR-583", true));
        DataWriter.saveCriminals();
    ...
    void testWritingEmptyCriminal() {
        criminalList.add(new Criminal("", "", "", "", "", 0, 0, "", "", "", "", 0.0, "", "", "", "", false, false, "",
                "", false));
        DataWriter.saveCriminals();
