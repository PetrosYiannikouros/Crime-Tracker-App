...
public class TestMain {
    public static void main(String[] args) {
        ...
        crimes.addCrime(100, TypesOfCrimes.INCHOATE, "Theft of X Gaming Console and 20 games", "03-03-2021 19:00",
                "1725 Harbinson Blvd", "edf66144-0dcb-40d1-b4f2-6cc1d60b1bc6");
        Crime crime = Crimes.search(100);
        crime.addSuspect(new Suspect("", "", "", "", 18, 150, "5'9\"", "White", "Male", 10, "Brown", "Shoulder length",
                "", "Gray hoodie", false, false, "", ""));
        crime.addVictim(new Victim("Henry", "Clemont", "803-898-7766", "123 Gervais St., Columbia SC, 29210",
